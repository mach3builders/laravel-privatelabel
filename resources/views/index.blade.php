                        ...
                        <div class="col-md-8">
                            @if ($private_label->hasMedia('logo_light'))
                                <div class="mb-1 form-control d-flex justify-content-between" style="background-color: #2d3748">
                                    ...
                                    <a href="{{ route('private-label.delete-media', $private_label->getFirstMedia('logo_light')) }}" class="align-self-start btn btn-sm ui-btn-icon text-white border-white">
                        ...
                        <div class="col-md-8">
                            @if ($private_label->hasMedia('logo_dark'))
                                <div class="mb-1 form-control d-flex justify-content-between">
                                    ...
                                    <a href="{{ route('private-label.delete-media', $private_label->getFirstMedia('logo_dark')) }}" class="align-self-start btn btn-sm ui-btn-icon btn-outline-light">
                                        <i class="far fa-trash"></i>
                                    </a>
                                </div>
                            @endif
                        ...
                        <div class="col-md-8">
                            @if ($private_label->hasMedia('favicon'))
                                <div class="mb-1 form-control d-flex justify-content-between">
                                    ...
                                    <a href="{{ route('private-label.delete-media', $private_label->getFirstMedia('favicon')) }}" class="align-self-start btn btn-sm ui-btn-icon btn-outline-light">
                                        <i class="far fa-trash"></i>
                                    </a>
                                </div>
                            @endif
